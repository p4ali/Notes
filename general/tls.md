## [generate ca and certs](https://github.com/nicholasjackson/mtls-go-example)

From https://github.com/nicholasjackson/mtls-go-example, this script describe the detail to create CA, chain, application, client certs and keys.
